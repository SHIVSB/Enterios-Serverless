...
import { getAllCancelledProjects } from "../src/controllers/Admin/allProjects/getAllCancelledProjects/getAllCancelledProjects";
  ...
  try {
    if (req.headers.authorization.startsWith("Bearer")) {
      ...
      if (result.error) {
        ...
        const projects = await getAllCancelledProjects();
